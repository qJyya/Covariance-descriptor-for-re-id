...
parser.add_argument('--test_dir',default='/media/data1/zhangquan/documents/GroupReID-SOT/dataset/WGU/',type=str, help='./test_data')
...
image_datasets = {x: dataset_WGU.LoadData(test_dir,os.path.join(test_dir,x+'.txt'),h,w) for x in ['gallery','query']}
...
scipy.io.savemat('WGU_result.mat',result)
