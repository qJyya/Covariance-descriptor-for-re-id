...
image_datasets = {x: dataset_city1m_1.LoadData(test_dir,os.path.join(test_dir,'two_protocols',x+'_part1.txt'),h,w) for x in ['gallery','query']}
...
scipy.io.savemat('city1m_part1.mat',result)
