...
import pdb
import os
import dataset_city1m_1_resize

os.environ["CUDA_VISIBLE_DEVICES"] = '3'

parser = argparse.ArgumentParser(description='Test')
parser.add_argument('--test_dir',default='/media/data3/zhangquan/dataset/City1M',type=str, help='./test_data')
...
h, w = int(1080/9),int(1920/9)

image_datasets = {x: dataset_city1m_1_resize.LoadData(test_dir,os.path.join(test_dir,'two_protocols',x+'_part1.txt'),h,w) for x in ['gallery','query']}
...
def extract_feature(dataloaders):
    ...
    cov_feature=(torch.stack(cov_list,dim=0)).to(device)
    return cov_feature   
...
scipy.io.savemat('city1m_part1_resize_cut2.mat',result)
